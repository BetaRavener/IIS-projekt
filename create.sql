...
insert into Objednavka (pk, stav, datumPrijatia, stornoPoplatok, kosik, odberatel_pk) 
values (null, 'přijatá', str_to_date('2014,11,14', '%Y,%m,%d'), 0, false, 1);
insert into Objednavka (pk, stav, datumPrijatia, stornoPoplatok, kosik, odberatel_pk) 
values (null, 'stornována', str_to_date('2014,10,14', '%Y,%m,%d'), 0, false, 2);
insert into Objednavka (pk, stav, datumPrijatia, stornoPoplatok, kosik, odberatel_pk) 
values (null, 'zrušená', str_to_date('2014,10,12', '%Y,%m,%d'), 0, false, 2);
insert into Objednavka (pk, stav, datumPrijatia, stornoPoplatok, kosik, odberatel_pk) 
values (null, 'vybavená', str_to_date('2014,10,11', '%Y,%m,%d'), 0, false, 2);
